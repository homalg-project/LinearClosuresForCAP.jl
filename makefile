...
uninstall:
	julia -e 'using Pkg; Pkg.rm("LinearClosuresForCAP");'

test:
	julia -e 'using Pkg; Pkg.test("LinearClosuresForCAP");'
...
git-commit:
	...
	echo -e "\033[32mCommitting changes in \"LinearClosuresForCAP\"\033[0m"; \
	git add .; \
	git commit \
		...
		echo -e "\033[33mNo changes in \"LinearClosuresForCAP\" to commit or no version bump detected.\033[0m"; \
	fi
