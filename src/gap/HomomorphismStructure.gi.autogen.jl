...
has_prerequisites_for_hom_structure =
    function( underlying_category )
      ...
      return IsSkeletalCategoryOfFiniteSets( RangeCategoryOfHomomorphismStructure( underlying_category ) ) &&
...
@InstallGlobalFunction( HOM_STRUCTURE_BASED_SORTING_FUNCTION_OR_FAIL_FOR_LINEAR_CLOSURE,
  ...
  function( underlying_category )
    ...
    if (IsSkeletalCategoryOfFiniteSets( RangeCategoryOfHomomorphismStructure( underlying_category ) ))
...
@InstallGlobalFunction( SET_HOMOMORPHISM_STRUCTURE_ATTRIBUTES_FOR_LINEAR_CLOSURE,
  ...
  function( category, rows )
    ...
    if (has_prerequisites_for_hom_structure( underlying_category ))
  ...
  function( category, rows )
    ...
    if (has_prerequisites_for_hom_structure( underlying_category ))
        ...
        FunctorObj = function( set )
            ...
            return CategoryOfRowsObject( rows, IntGAP( Length( set ) ) );
        end;
        ...
        AddInterpretMorphismFromDistinguishedObjectToHomomorphismStructureAsMorphism( category,
          function( cat, a, b, mor )
            ...
            return MorphismConstructor( cat,
                           a,
                           PairGAP( EntriesOfHomalgMatrix( UnderlyingMatrix( mor ) ),
                                 List( (0):(size - 1), i ->
                                       InterpretMorphismFromDistinguishedObjectToHomomorphismStructureAsMorphism(
                                               a_und,
                                               b_und,
